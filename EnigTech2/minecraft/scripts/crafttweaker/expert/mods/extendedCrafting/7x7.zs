...
//强化飞行背包
TableCrafting.addShaped(3, <simplyjetpacks:itemjetpack:18>.withTag({Energy: 0, JetpackParticle: 0}), [
...
//谐振飞行背包
TableCrafting.addShaped(3, <simplyjetpacks:itemjetpack:19>.withTag({Energy: 0, JetpackParticle: 0}), [
	[null, null, null, null, null, null, null], 
	[null, null, <ore:dustAstralStarmetal>, <contenttweaker:charged_gaiya_crystal>, <ore:dustAstralStarmetal>, null, null], 
